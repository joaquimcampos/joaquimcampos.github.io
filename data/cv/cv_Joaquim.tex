...
\begin{document}
  ...
  \begin{center}
    \begin{tabular}{lcr}
	    \par{\centering{\Huge Joaquim \textsc{Campos}}\bigskip\par} & & \includegraphics[width=0.3\textwidth]{../main/Joaquim2.png} \\
    \end{tabular}
  \end{center}
  ...
  \section{Work experience}
    ...
    \begin{tabular}{r|p{13cm}}
      ...
      \textsc{Present} 	& Co-Founder and CTO at \href{https://www.radiobooks.io}{$\textnormal{radio}\boldsymbol{\beta}\textnormal{ooks}$}. \\
      \textsc{2022 Aug} 	& \emph{Goal: To convert books into audiobooks automatically using Artificial Intelligence}.
      \begin{itemize}[leftmargin=*,noitemsep]
          \item \footnotesize{Designed and created an app for revising synthetically-generated audio from a .pdf or .epub file (launch: May 2023);}
          \item \footnotesize{\textbf{Milestone} (Apr 2023): Secured a €$200\,000$ euro investment from \href{https://www.portugalventures.pt/en/}{Portugal Ventures} in a Pre-Seed round.}
