...
class InlineGithubLogo extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16" style="--darkreader-inline-fill: currentColor; margin-bottom: -3px;" data-darkreader-inline-fill="">
                ${logo_path}
            </svg>
        `;
    }
