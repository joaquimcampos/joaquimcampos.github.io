...
\begin{document}
  ...
  \section{Teaching experience}
    ...
    \begin{tabular}{rp{11cm}}
  	Expertise:  & Both theoretical and practical aspects of machine learning, deep learning, and signal processing; Python development.
    \vspace{5pt}\\
  	DevOps Experience:       &  \textsc{Python, FastAPI, Pytest, PyTorch, CI/CD, Bash, Linux, MongoDB, Docker, Github Actions, Codecov, AWS, Fly.io, Better Stack.}  \vspace{5pt}\\
